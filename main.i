...
extern const unsigned short level3BackMap[2048];
...
void drawCurLevel() {
    ...
    (*(volatile unsigned short *)0x4000008) = ((1) << 2) | ((28) << 8) | (0 << 14) | (1 << 7);
    ...
    switch (curLevel) {
        case 0:
            ...
            DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[1], 4928/2);
        ...
        case 1:
            ...
            DMANow(3, level1Tiles, &((charblock *)0x6000000)[1], 2304/2);
            DMANow(3, level1Map, &((screenblock *)0x6000000)[28], 2048/2);
            break;
        case 2:
            ...
            DMANow(3, level2Tiles, &((charblock *)0x6000000)[1], 1984/2);
            DMANow(3, level2Map, &((screenblock *)0x6000000)[28], 2048/2);

            (*(volatile unsigned short *)0x4000000) |= (1 << 9);
            (*(volatile unsigned short *)0x400000A) = ((0) << 2) | ((16) << 8) | (3 << 14);

            DMANow(3, level2BackTiles, &((charblock *)0x6000000)[0], 5024/2);
            DMANow(3, level2BackMap, &((screenblock *)0x6000000)[16], 8192/2);
            break;
        case 3:
            ...
            DMANow(3, level3Pal, ((unsigned short *)0x5000000), 512/2);
            DMANow(3, level3Tiles, &((charblock *)0x6000000)[1], 3520/2);
            DMANow(3, level3Map, &((screenblock *)0x6000000)[28], 2048/2);


            (*(volatile unsigned short *)0x4000000) |= (1 << 9);
            (*(volatile unsigned short *)0x400000A) = ((0) << 2) | ((16) << 8) | (1 << 14) | (1 << 7);

            DMANow(3, level3BackTiles, &((charblock *)0x6000000)[0], 13696/2);
            DMANow(3, level3BackMap, &((screenblock *)0x6000000)[16], 4096/2);
            break;
    }
}
...
void game() {
    ...
    if ((!(~(oldButtons) & ((1 << 3))) && (~buttons & ((1 << 3)))) && player.level != 0) {
            goToPause();
    }
